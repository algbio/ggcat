...
use config::{
    ...
    DEFAULT_TARGET_CHUNK_SIZE_MULTIPLIER, MAX_BUCKET_SIZE, MAX_BUCKETS_CHUNK_SIZE,
    MAX_BUCKETS_COUNT_LOG, MAX_COMPACTION_ITERATIONS, MAX_TARGET_CHUNK_SIZE, MIN_BUCKET_SIZE,
    MIN_BUCKETS_CHUNK_SIZE, MIN_BUCKETS_COUNT_LOG, MIN_TARGET_CHUNK_SIZE,
};
