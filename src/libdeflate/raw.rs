...
pub const LIBDEFLATE_VERSION_MINOR: u32 = 7;
pub const LIBDEFLATE_VERSION_STRING: &'static [u8; 4usize] = b"1.7\0";
...
pub type flush_buffer_func = ::std::option::Option<
    unsafe extern "C" fn(
        flush_data: *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn libdeflate_deflate_decompress(
        ...
        out: *mut ::std::os::raw::c_void,
        out_nbytes_avail: size_t,
        actual_out_nbytes_ret: *mut size_t,
    ) -> libdeflate_result;
}
extern "C" {
    pub fn libdeflate_deflate_decompress_ex(
        ...
        out: *mut ::std::os::raw::c_void,
        out_nbytes_avail: size_t,
        actual_in_nbytes_ret: *mut size_t,
        actual_out_nbytes_ret: *mut size_t,
        flush_func: flush_buffer_func,
        flush_data: *mut ::std::os::raw::c_void,
    ) -> libdeflate_result;
}
extern "C" {
...
extern "C" {
    pub fn libdeflate_crc32(crc: u32, buffer: *const ::std::os::raw::c_void, len: size_t) -> u32;
}
extern "C" {
