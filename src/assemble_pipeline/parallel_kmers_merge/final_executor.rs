use crate::assemble_pipeline::parallel_kmers_merge::map_processor::ParallelKmersMergeMapPacket;
use crate::assemble_pipeline::parallel_kmers_merge::structs::{MapEntry, ResultsBucket};
use crate::assemble_pipeline::parallel_kmers_merge::{
    GlobalMergeData, ParallelKmersMergeFactory, READ_FLAG_INCL_BEGIN, READ_FLAG_INCL_END,
};
