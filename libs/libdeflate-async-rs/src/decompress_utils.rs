...
pub struct DecompressDeflateData<'a> {
    ...
    // u16 tmp16;
    // u32 tmp32;
    pub input_stream: &'a mut DeflateAsyncChunkedBufferInput,
    pub output_stream: &'a mut DeflateAsyncChunkedBufferOutput,
}

impl<'a> DecompressDeflateData<'a> {
    pub fn new(
        in_stream: &'a mut DeflateAsyncChunkedBufferInput,
        out_stream: &'a mut DeflateAsyncChunkedBufferOutput,
    ) -> Self {
        DecompressDeflateData {
            bitbuf: 0,
            bitsleft: 0,
            overrun_count: 0,
 ...
 */
#[inline(always)]
pub fn fill_bits_bytewise<'a>(data: &mut DecompressDeflateData<'_>) {
    loop {
 ...
 */
#[inline(always)]
pub unsafe fn fill_bits_wordwise(data: &mut DecompressDeflateData<'_>) {
 ...
 */
#[inline(always)]
pub fn have_bits<R: for<'r> crate::AsyncReadBuffer<'r>>(
    data: &mut DecompressDeflateData<'_>,
    n: usize,
) -> bool {
    data.bitsleft >= n
}
 ...
 */
#[inline(always)]
pub fn ensure_bits<R: for<'r> crate::AsyncReadBuffer<'r>>(
    data: &mut DecompressDeflateData<'_>,
    n: usize,
) {
    if !have_bits(data, n) {
 ...
 */
#[inline(always)]
pub fn bits<R: for<'r> crate::AsyncReadBuffer<'r>>(
    data: &mut DecompressDeflateData<'_>,
    n: usize,
) -> u32 {
 ...
 */
#[inline(always)]
pub fn remove_bits<R: for<'r> crate::AsyncReadBuffer<'r>>(
    data: &mut DecompressDeflateData<'_>,
    n: usize,
) {
    data.bitbuf >>= n;
 ...
 */
#[inline(always)]
pub fn pop_bits<R: for<'r> crate::AsyncReadBuffer<'r>>(
    data: &mut DecompressDeflateData<'_>,
    n: usize,
) -> u32 {
    let tmp = bits(data, n);
 ...
 */
#[inline(always)]
pub fn align_input<R: for<'r> crate::AsyncReadBuffer<'r>>(
    data: &mut DecompressDeflateData<'_>,
 ...
 */
#[inline(always)]
pub unsafe fn read_u16(data: &mut DecompressDeflateData<'_>) -> u16 {
    let mut bytes = [0, 0];
 ...
 * at runtime.
 */
pub async fn libdeflate_deflate_decompress(
    d: &mut LibdeflateDecompressor,
    in_stream: &mut DeflateAsyncChunkedBufferInput,
    out_stream: &mut DeflateAsyncChunkedBufferOutput,
) -> Result<(), LibdeflateError> {
    deflate_decompress_template(d, in_stream, out_stream).await
}
